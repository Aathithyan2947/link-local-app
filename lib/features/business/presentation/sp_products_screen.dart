...
/// Reached from the Service Type onboarding step's "Manage items" link and from My Shop.
/// It used to double as a chain step itself, replacing the whole Service Type category —
